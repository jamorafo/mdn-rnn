...
X_set = data_scaled[0:(data_scaled.shape[0]-lookback),]
Y_set = data_scaled[lookback:(data_scaled.shape[0]),]
...
for cc in range(0,5):
    ...
    fig.savefig("output/"+ folder +"/" + test_name + "/MDN_" + data.columns[cc] + ".pdf", bbox_inches='tight')
